export default {
    ...
    -----END PUBLIC KEY-----`,
    privatekey: `-----BEGIN RSA PRIVATE KEY-----MIIBOgIBAAJBAJEJhQ8bDAVDb0roYVnqNDaQ/ojPaQnw+3MlhaCL0VAY6tKUvqLm
    ...
    TLjYTuUHmbd6DrV0UbSVOW12xrLdCeIh9DRdwo08-----END RSA PRIVATE KEY-----`
